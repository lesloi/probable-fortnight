...
public class IHM_Commission extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jFrame1.setTitle("Demandes de vaidation d'offre de stage");
        
        jLabel1.setText("Etudiant:");

        jLabel2.setText("Intitulé Stage:");

        jLabel3.setText("Entreprise:");

        jLabel4.setText("Descritption:");

        jAccepterButton.setText("Accepter");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(IHM_Commission.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new IHM_Commission().setVisible(true);
            }
        });
    }
